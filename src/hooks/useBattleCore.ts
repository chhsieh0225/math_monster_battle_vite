...
export function useBattle() {
  ...
  const {
    ...
    mHits, mLvls, mLvlUp,
    burnStack, tideStack, enemyExposed, frozen, shattered, staticStack, specDef, defAnim, cursed,
    diffLevel,
  ...
  const sr = useBattleStateRef({
    ...
    streak, passiveCount, charge, burnStack, tideStack, enemyExposed, frozen, shattered, staticStack, specDef, cursed,
  ...
  const state = buildUseBattleState({
    ...
    dmgs, parts, eAnim, pAnim, eSubAnim, pSubAnim, atkEffect, effMsg,
    burnStack, tideStack, enemyExposed, frozen, shattered, staticStack, specDef, defAnim, cursed,
