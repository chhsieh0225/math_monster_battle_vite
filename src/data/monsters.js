...
export const SLIME_VARIANTS = [
  { name:"綠史萊姆", svgFn:slimeSVG,       c1:"#4ade80",c2:"#16a34a", mType:"grass",    typeIcon:"🌿", typeName:"草", drops:["🍬","🧪"] },
  { name:"紅史萊姆", svgFn:slimeRedSVG,     c1:"#f87171",c2:"#b91c1c", mType:"fire",     typeIcon:"🔥", typeName:"火", drops:["🔥","🍬"] },
  { name:"藍史萊姆", svgFn:slimeBlueSVG,    c1:"#60a5fa",c2:"#1d4ed8", mType:"water",    typeIcon:"💧", typeName:"水", drops:["💧","🍬"] },
  { name:"黃史萊姆", svgFn:slimeYellowSVG,  c1:"#facc15",c2:"#ca8a04", mType:"electric", typeIcon:"⚡", typeName:"電", drops:["⚡","🍬"] },
  { name:"黑史萊姆", svgFn:slimeDarkSVG,    c1:"#a1a1aa",c2:"#3f3f46", mType:"dark",     typeIcon:"💀", typeName:"暗", drops:["💀","🍬"] },
  { name:"鋼史萊姆", svgFn:slimeSteelSVG,   c1:"#94a3b8",c2:"#475569", mType:"steel",    typeIcon:"🛡️", typeName:"鋼", drops:["🛡️","🍬"] },
];
