export default function HPBar({ cur, max, color, label }) {
  ...
  return (
    <div style={{ background: "rgba(0,0,0,0.65)", borderRadius: 12, padding: "8px 12px", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.1)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
        ...
        <span style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", fontFamily: "'Press Start 2P',monospace" }}>{Math.max(0, Math.ceil(cur))}/{max}</span>
      </div>
